...
/*****
 * This is a very simple example of a lexical analyzer
 * for simple words, part of a pascal compiler.
 * 
 */
...
public class ExpScanner {
   ...
   */
  public ExpScanner(java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public ExpToken nextToken() throws java.io.IOException {
    int zzInput;
    int zzAction;
